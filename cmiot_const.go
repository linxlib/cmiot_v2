...
const (
	...
	//EBID_useropenservice            = "0001000000447" //单个用户已开通服务查询
	//EBID_querygroupuserchangenum    = "0001000008894" //集团用户数变化信息查询
	//EBID_querycardopentime = "0001000000901" //物联卡开户日期查询
	//EBID_batchquerycardinfo         = "0001000000928" //码号信息批量查询
	//EBID_batchquerycardlifecycle = "0001000000929" //物联卡生命周期批量查询
	//EBID_batchquerymonthsmsinfo     = "0001000000930" //物联卡当月套餐内短信信息批量查询
	//EBID_batchqueryrealtimegprsinfo = "0001000000931"
	//EBID_querygprsshareused         = "0001000008899" //物联卡当月流量共享使用信息实时查询
	//EBID_batchquerygprsshareused    = "0001000008900" //物联卡当月流量共享使用信息实时批量查询
